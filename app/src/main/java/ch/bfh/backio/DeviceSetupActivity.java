...
public abstract class DeviceSetupActivity extends AppCompatActivity implements ServiceConnection, FragmentSettings {
    ...
    public static class ReconnectDialogFragment extends DialogFragment implements  ServiceConnection {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            btDevice = Objects.requireNonNull(getArguments()).getParcelable(KEY_BLUETOOTH_DEVICE);
            Objects.requireNonNull(getActivity()).getApplicationContext().bindService(new Intent(getActivity(), BtleService.class), this, BIND_AUTO_CREATE);
